        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="section-subtitle animate-fadeInUp">
              <span className="text-pink-600">Committed to empowering excellence in clinical research</span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInLeft">
              <div className="glass rounded-2xl p-8 border border-blue-900">
                <h2 className="text-2xl font-bold mb-6 text-center text-pink-600">Our Mission</h2>
            ...
            <div className="animate-fadeInRight">
              <div className="glass rounded-2xl p-8 border border-blue-900">
                <h2 className="text-2xl font-bold mb-6 text-center text-pink-600">Our Vision</h2>
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
